...
function Platform() {
	...
	if (score >= 5000) this.types = [1, 2, 3, 4, 4];
	else if (score >= 2000 && score < 5000) this.types = [1, 2, 3, 3, 4,];
	else if (score >= 1000 && score < 2000) this.types = [1, 1, 2, 3, 4,];
	else if (score >= 500 && score < 1000) this.types = [1, 1, 1, 2, 3, ];
	else if (score >= 100 && score < 500) this.types = [1, 1, 1, 1, 2, ];
	else this.types = [1];

	this.type = this.types[Math.floor(Math.random() * this.types.length)];

  	if (score >= 5000) { gravity = 0.4;}
...
function init() {
	...
	function playerCalc() {
		...
		//Movement of player affected by 
